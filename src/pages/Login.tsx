  ...
  return (
    <div>
      <section className="bg-gray-50 dark:bg-gray-900 w-96">
        <div className="w-96 lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
          ...
          <form className="mt-8 space-y-6" action="#">
            ...
            <div className="text-sm font-medium text-gray-900 dark:text-white">
              ...
              <a
                onClick={handleNavigate}
                className="ml-24 text-blue-600 hover:underline dark:text-blue-500"
              >
                Create account
              </a>
            </div>
